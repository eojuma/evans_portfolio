...
type Project = { slug: string; title: string; tag: string; description: string; role: string; stack: string[]; outcome: string; status: string; repo?: string; live?: string };
...
const fallback: Portfolio = {
  ...
  projects: [
    ...
    { slug: "business-os", title: "Business OS", tag: "AI for SMEs", description: "Chat-first operating system for inventory, sales, and business records.", role: "Backend engineer", stack: ["Go", "Gin", "PostgreSQL", "Docker", "Next.js"], outcome: "Implemented authentication and authorization in a modular, containerized backend.", status: "In progress", repo: "https://github.com/eojuma/Business-OS", live: "https://business-os-silk.vercel.app" },
    ...
    { slug: "guidely", title: "Guidely", tag: "Production RAG", description: "RAG application independently audited for reliability and security.", role: "Solo auditor", stack: ["FastAPI", "FAISS", "React", "Gemini"], outcome: "Resolved 8 production issues and migrated embeddings from OpenAI to Gemini.", status: "Completed", repo: "https://github.com/eojuma/Guidely" },
    ...
    { slug: "social-network", title: "Social Network Platform", tag: "Real-time systems", description: "Zone01 team project with real-time conversations.", role: "Backend engineer on a 4-person team", stack: ["Go", "WebSockets", "SQLite"], outcome: "Implemented real-time chat and the supporting social graph.", status: "Completed", repo: "https://github.com/eojuma/01-projects", live: "https://social-network-dusky.vercel.app" },
...
function App() {
  ...
  const githubUser = data.contact.github?.split("/").filter(Boolean).pop() ?? "eojuma";
