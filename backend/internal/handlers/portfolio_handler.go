...
func GetPortfolio(c *gin.Context) {
	c.JSON(http.StatusOK, PortfolioResponse{
		...
		Projects: []PortfolioProject{
			...
			{Slug: "guidely", Title: "Guidely", Tag: "Production RAG", Description: "RAG application independently audited for reliability and security.", Role: "Solo auditor", Stack: []string{"FastAPI", "FAISS", "React", "Gemini"}, Outcome: "Resolved 8 production issues and migrated embeddings from OpenAI to Gemini.", Status: "Not deployed"},
