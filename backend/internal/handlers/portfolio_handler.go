...
func GetPortfolio(c *gin.Context) {
	c.JSON(http.StatusOK, PortfolioResponse{
		...
		Projects: []PortfolioProject{
			...
			{Slug: "business-os", Title: "Business OS", Tag: "AI for SMEs", Description: "Chat-first operating system for inventory, sales, and business records.", Role: "Backend engineer", Stack: []string{"Go", "Gin", "PostgreSQL", "Docker", "Next.js"}, Outcome: "Implemented authentication and authorization in a modular, containerized backend.", Status: "In progress", Repo: "https://github.com/eojuma/Business-OS", Live: "https://business-os-silk.vercel.app"},
			{Slug: "african-vault", Title: "African Vault", Tag: "Fintech", Description: "Banking and payments platform with account management and transfers.", Role: "Solo engineer", Stack: []string{"Go", "SQLite", "JavaScript", "REST"}, Outcome: "Built phone-number payments, PDF and CSV statements, and ACID-compliant transaction flows.", Status: "In progress"},
			{Slug: "guidely", Title: "Guidely", Tag: "Production RAG", Description: "RAG application independently audited for reliability and security.", Role: "Solo auditor", Stack: []string{"FastAPI", "FAISS", "React", "Gemini"}, Outcome: "Resolved 8 production issues and migrated embeddings from OpenAI to Gemini.", Status: "Not deployed", Repo: "https://github.com/eojuma/Guidely"},
			{Slug: "social-network", Title: "Social Network Platform", Tag: "Real-time systems", Description: "Zone01 team project with real-time conversations.", Role: "Backend engineer on a 4-person team", Stack: []string{"Go", "WebSockets", "SQLite"}, Outcome: "Implemented real-time chat and the supporting social graph.", Status: "Completed", Repo: "https://github.com/eojuma/01-projects", Live: "https://social-network-dusky.vercel.app"},
